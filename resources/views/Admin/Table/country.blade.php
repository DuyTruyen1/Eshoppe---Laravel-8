    ...
    <div class="container-fluid">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $country->name }}</td>
                                        <td>
                                            <a href="{{route('Table.edit',['id'=>$country->id])}}" class="btn btn-warning btn-sm">Sửa</a>
                                        </td>
                                        <td>
                                            
                                            <a onclick="return confirm('Có chắc chắn muốn xoá?')"
                                             href="{{route('Table.delete',['id'=>$country->id])}}" class="btn btn-warning btn-sm">Xoá</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title m-t-40"><i class="m-r-5 font-18 mdi mdi-numeric-2-box-outline"></i> Add New Country</h6>
                        <form action="" method="POST">
                            ...
                            <a href="{{route('add')}}" class="btn btn-primary">Thêm Quốc Gia</a>
                        </form>
                    </div>
                </div>
            </div>
