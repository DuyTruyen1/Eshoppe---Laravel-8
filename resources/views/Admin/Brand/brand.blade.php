                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $brand->name }}</td>
                                        <td>
                                            <a href="{{route('Brand.edit',['id'=>$brand->id])}}" class="btn btn-warning btn-sm">Sửa</a>
                                        </td>
                                        <td>
                                            
                                            <a onclick="return confirm('Có chắc chắn muốn xoá?')"
                                             href="{{route('Brand.delete',['id'=>$brand->id])}}" class="btn btn-warning btn-sm">Xoá</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="" method="POST">
                            ...
                            <a href="{{route('add')}}" class="btn btn-primary">Thêm Thương Hiệu</a>
                        </form>
                    </div>
                </div>
            </div>
