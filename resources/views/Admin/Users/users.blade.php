        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-xlg-3 col-md-5">
                <div class="card">
                    <div class="card-body">
                        <center class="m-t-30">
                            <img src="{{ asset('Admin/assets/images/users/5.jpg') }}" class="rounded-circle" width="150" />
            ...
            <div class="col-lg-8 col-xlg-9 col-md-7">
                <div class="card">
                    <div class="card-body">
                        <form class="form-horizontal form-material" method="POST" action="{{ route('admin.users') }}"  enctype="multipart/form-data">
                          {{-- nhớ phải thêm csrf ở dưới --}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea rows="5" id="message" name="message" class="form-control form-control-line"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
